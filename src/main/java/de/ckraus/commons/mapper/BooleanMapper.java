...
//    protected static Logger log = LoggerFactory.getLogger(BooleanMapper.class);
    ...
    public boolean isFalse(Character c) {
        ...
        if (null != c) {
            bIsFalse = this.getFalseCharacterValues().stream().anyMatch(
                    character -> character.equals(c)
            );
        }
        return bIsFalse;
    }
    ...
    public boolean isFalse(Integer i) {
        ...
        if (null != i) {
            bIsFalse = this.getFalseIntegerValues().stream().anyMatch(
                    integer -> integer.equals(i)
            );
        }
        return bIsFalse;
    }
    ...
    public boolean isFalse(String s) {
        ...
        if (null != s) {
            bIsFalse = this.getFalseStringValues().stream().anyMatch(
                    string -> string.trim().equalsIgnoreCase(s.trim())
            );
        }
        return bIsFalse;
    }
    ...
    public boolean isTrue(Character c) {
        ...
        if (null != c) {
            bIsTrue = this.getTrueCharacterValues().stream().anyMatch(
                    character -> character.equals(c)
            );
        }
        return bIsTrue;
    ...
    public boolean isTrue(Integer i) {
        ...
        if (null != i) {
            bIsTrue = this.getTrueIntegerValues().stream().anyMatch(
                    integer -> integer.equals(i)
            );
        }
        return bIsTrue;
    ...
    public boolean isTrue(String s) {
        ...
        if (null != s) {
            bIsTrue = this.getTrueStringValues().stream().anyMatch(
                    string -> string.trim().equalsIgnoreCase(s.trim())
            );
        }
        return bIsTrue;
