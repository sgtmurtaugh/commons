...
class ITypeMapperTest {
    ...
    void evalPredicate() {
        // success checks
        assertTrue( mapper.evalPredicate( (obj) -> obj instanceof String, getParameters().get(PARAMS_KEY__STRING) ) );
        assertTrue( mapper.evalPredicate( Objects::isNull, null ) );

        // fail checks
        assertFalse( mapper.evalPredicate( (obj) -> obj instanceof Integer, getParameters().get(PARAMS_KEY__STRING) ) );
    }
    ...
    void map2() {
        ...
        assertEquals( mapper.getDefaultValue(), mapper.map(getParameters().get(PARAMS_KEY__STRING__UNTRIMMED_EMPTY)) );
    ...
    @Test
    void map3() {
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__NO_KEY), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__NO_VALUE), ANOTHER_DEFAULT_VALUE ) );

        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__BIG_DECIMAL), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__BIG_DECIMAL_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__BIG_INTEGER), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__BIG_INTEGER_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__BOOLEAN), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__BOOLEAN_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__BYTE), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__BYTE_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__CALENDAR), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__CALENDAR_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__CHARACTER), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__DOUBLE), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__DOUBLE_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__FLOAT), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__FLOAT_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__INTEGER), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__INTEGER_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__LIST), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__LOCALDATE), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__LOCALDATE_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__LOCALDATETIME), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__LOCALDATETIME_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__LOCALTIME), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__LOCALTIME_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__LONG), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__LONG_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__OBJECT), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__SHORT), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__SHORT_STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__STRING), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__STRING__EMPTY), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__STRING__UNTRIMMED), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__STRING__UNTRIMMED_EMPTY), ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE, mapper.map( getParameters().get(PARAMS_KEY__STRING_BUILDER), ANOTHER_DEFAULT_VALUE ) );
    }
    ...
    void map7() {
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING), false, false, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING), false, true, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING), true, false, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING), true, true, ANOTHER_DEFAULT_VALUE ) );

        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__EMPTY), false, false, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__EMPTY), false, true, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__EMPTY), true, false, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__EMPTY), true, true, ANOTHER_DEFAULT_VALUE ) );

        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__UNTRIMMED), false, false, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__UNTRIMMED), false, true, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__UNTRIMMED), true, false, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__UNTRIMMED), true, true, ANOTHER_DEFAULT_VALUE ) );

        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__UNTRIMMED_EMPTY), false, false, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__UNTRIMMED_EMPTY), false, true, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
                mapper.map( (String) getParameters().get(PARAMS_KEY__STRING__UNTRIMMED_EMPTY), true, false, ANOTHER_DEFAULT_VALUE ) );
        assertEquals( ANOTHER_DEFAULT_VALUE,
