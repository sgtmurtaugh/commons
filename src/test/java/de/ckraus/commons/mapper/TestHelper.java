...
public class TestHelper {
    ...
    public static final String PARAMS_KEY__BIG_DECIMAL              = "bigDecimal";
    public static final String PARAMS_KEY__BIG_DECIMAL_STRING       = "bigDecimalString";
    public static final String PARAMS_KEY__BIG_INTEGER              = "bigInteger";
    public static final String PARAMS_KEY__BIG_INTEGER_STRING       = "bigIntegerString";
    ...
    public static final String PARAMS_KEY__BYTE                     = "byte";
    public static final String PARAMS_KEY__BYTE_STRING              = "byteString";
    ...
    public static final String PARAMS_KEY__SHORT                    = "short";
    public static final String PARAMS_KEY__SHORT_STRING             = "shortString";
    ...
    static {
        ...
        parameters.put(PARAMS_KEY__BYTE, 1);
        ...
        parameters.put(PARAMS_KEY__SHORT, 127);
